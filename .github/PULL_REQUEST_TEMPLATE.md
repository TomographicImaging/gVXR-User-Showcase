...
- [ ] I have added the gVXR version I ran with near the top of my file(s)
- [ ] The content of this Pull Request (the Contribution) is intentionally submitted for inclusion in gVXR-User-Showcase.
...
Note: for an example of a contribution, where a license header, description, data link and gVXR version has been added, please
see: [example_contribution](https://github.com/TomographicImaging/gVXR-User-Showcase/blob/main/example_contribution)
